...
def configure(repl):
    ...
    repl.install_ui_colorscheme('blue', _blue_ui_style)
...
_blue_ui_style = {}
_blue_ui_style.update(default_ui_style)
_blue_ui_style.update({
        # Blue prompt.
        ...
        # Make the status toolbar blue.
        Token.Toolbar.Status:                         'bg:#44bbbb #000000',
